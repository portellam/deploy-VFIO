...
**[Latest release](https://codeberg.org/portellam/deploy-VFIO/releases/latest)**

### Related Projects
[Deploy VFIO](https://codeberg.org/portellam/deploy-VFIO) | **[Auto X.Org](https://codeberg.org/portellam/auto-xorg)** | **[Generate Evdev](https://codeberg.org/portellam/generate-evdev)**

**[Guest Machine Guide](https://codeberg.org/portellam/guest-machine-guide)** | **[Libvirt Hooks](https://codeberg.org/portellam/libvirt-hooks)** | **[Power State Virtual Machine Manager](https://codeberg.org/portellam/powerstate-virtmanager)**
...
- To download this script, you may:
  - Download the [latest release](https://codeberg.org/portellam/deploy-VFIO/releases/latest).
...
1. **Allocate CPU**
  ...
  -  If installed, the **Dynamic** [Libvirt hook](https://codeberg.org/portellam/libvirt-hooks) (see source) will skip its execution, to preserve the Static isolation.
...
- **Multi-boot VFIO setup**
  ...
  - **Ad:** For best results, use [Auto X.Org](https://codeberg.org/portellam/auto-xorg).
...
2. **Guest Audio Capture**
  - Create an [audio loopback](https://codeberg.org/portellam/audio-loopback) to output on the Host audio device Line-Out.
...
&ensp;<sub>**[GitHub project source](https://codeberg.org/portellam/portellam/generate-evdev)**</sub>
#### Hugepages
...
### Contact
Did you encounter a bug? Do you need help? Notice any dead links? Please contact by [raising an issue](https://codeberg.org/portellam/issues) with the project itself.