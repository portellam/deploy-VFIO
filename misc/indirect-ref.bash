...
echo
echo -e "var1 = $var1\t(direct ref)"       # Direct reference
echo -e "alpha = $alpha\t(direct ref)"     # Direct reference
eval var1=\$$var1                          # Indirect reference
echo -e "var1 = $var1\t(indirect ref)"     # Indirect reference
echo
var1="alpha"
echo -e "var1 = $var1\t(direct ref)"       # Direct reference
var1=$alpha                                # update variable
echo -e "var1 = $var1\t(indirect ref)"     # Indirect reference
