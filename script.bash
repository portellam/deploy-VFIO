...
# <code>
    ...
    function CheckIfDaemonIsActiveOrNot
    {
        ...
        local readonly var_keyword_failed='failed'
        local readonly var_keyword_inactive='inactive'
        ...
        case "${var_command_output}" in
            *"${var_keyword_failed}"* | *"${var_keyword_inactive}"* )
...
# <code>
    ...
    function WriteFile
    {
        ...
        # <params>
        declare -I arr_file
        local readonly str_file_contents="${arr_file[@]}"
        local readonly str_output_fail="${var_prefix_fail} Could not write to file '${1}'."
        # </params>

        CheckIfVarIsValid "${str_file_contents}" || return "${?}"
...
# <code>
    ...
    function Modify_QEMU
    {
        function Modify_QEMU_Main
        {
            ...
            if CheckIfVarIsValid "${str_username}" &> /dev/null; then
                arr_file1_contents+=(
                    ""
                    "### User permissions ###"
                    "user = \"${str_username}\""
            ...
            TryThisXTimesBeforeFail "${var_restart_daemon}" || return 1
            return 0
        }
